...
from ksr_app.models import AbstractModel, AddressVO
...
class UserOwnedAddress(AbstractModel, AddressVO):
    owned_user = models.ForeignKey(User, on_delete=models.CASCADE, null=False)
    #  최근 주소 , 집, 회사
    address_category = models.CharField(null=False, default='최근 주소', max_length=50)
